...
<Tabs>
  ...
  <Tab title="Embedded Floating iFrame">
    ...
    **Multiple embedded instances on the same page:**
    ...
    <script
      type="module"
      src="https://widget.contextgpt.co/loader.js?instance=sidebar"
      data-chatbot-id="YOUR_CHATBOT_ID"
      data-mode="embedded"
    ...
    <script
      type="module"
      src="https://widget.contextgpt.co/loader.js?instance=inline"
      data-chatbot-id="YOUR_CHATBOT_ID"
      data-mode="embedded"
  ...
  <Accordion title="Custom HTML" icon="code">
    ...
    **Example:**
    ...
    <body>
        ...
        s.src="https://ContextGPT.co/widget/YOUR_CHATBOT_ID.js";s.async=1;
