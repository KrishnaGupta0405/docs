...
<Tabs>
  ...
  <Tab title="REST API" icon="brackets-curly">
    ...
    **Base URL:** `https://contextgpt.in/api/v1`
...
<script src="https://ContextGPT.in/widget/your-chatbot-id.js" defer></script>
```
...
```javascript theme={null}
const response = await fetch('https://ContextGPT.in/api/v0/chatbots/your-chatbot-id/message', {
  method: 'POST',
  headers: {
...
```bash theme={null}
curl https://ContextGPT.in/api/v0/chatbots \
...
* **Email support**: [support@ContextGPT.in](mailto:support@ContextGPT.in)
