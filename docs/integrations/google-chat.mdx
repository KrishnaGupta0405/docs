...
* Google Chat integration feature enabled (contact [support@ContextGPT.in](mailto:support@ContextGPT.in) to request access)
...
<Steps>
  <Step title="Access the integration in ContextGPT">
    ...
    <Note>You need to request access from [support@ContextGPT.in](mailto:support@ContextGPT.in) before you can activate this integration.</Note>
  </Step>
