  ...
  <Tab title="From the Zendesk Marketplace" icon="store">
    ...
    <Steps>
      <Step title="Find the listing in the Zendesk Marketplace">
        ...
        listing. Zendesk redirects you to `https://ContextGPT.co/connect-zendesk`.
      </Step>
      ...
      <Step title="Pick the chatbot to connect">
        ...
        <Info>Don't have a chatbot yet? The picker shows a **Create a chatbot** CTA. Train a chatbot first, then come back to `https://ContextGPT.co/connect-zendesk` and the picker will list it.</Info>
      </Step>
...
<Tabs>
  ...
  <Tab title="Reconnect" icon="arrows-rotate">
    ...
    start from `https://ContextGPT.co/connect-zendesk` and pick the chatbot from
    the list.
  ...
  <Tab title="Switch to a different chatbot" icon="right-left">
    ...
    2. Go to `https://ContextGPT.co/connect-zendesk`, pick the new chatbot, and
       click **Connect**.
  </Tab>
</Tabs>
...
<AccordionGroup>
  ...
  <Accordion title="Install failed with a 'connection' or 'webhook' error" icon="plug-circle-xmark">
    ...
    1. Go to `https://ContextGPT.co/connect-zendesk`, pick the chatbot, and
       click **Connect** to retry the full install.
    2. If retrying doesn't help, contact [support@ContextGPT.co](mailto:support@ContextGPT.co) with your
